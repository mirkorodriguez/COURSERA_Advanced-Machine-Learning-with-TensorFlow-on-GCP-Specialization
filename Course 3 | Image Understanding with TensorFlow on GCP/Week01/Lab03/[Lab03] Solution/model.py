...
def dnn_dropout_model(img, mode, hparams):
  ...
  # Droput only on training mode
  dh4 = tf.layers.dropout(h2, rate=dprob, training=(mode == tf.estimator.ModeKeys.TRAIN))
  ylogits = tf.layers.dense(dh4, NCLASSES, activation=None)
  return ylogits, NCLASSES
